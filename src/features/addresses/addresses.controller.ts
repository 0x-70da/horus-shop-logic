...
export const getAddresses = async (req: Request, res: Response) => {
  try {
    ...
    const { data, error } = await supabase
      .from("addresses")
      .select(
        "id, full_name, address_line, city, state, country, phone, zip_code, is_default, created_at",
      )
      .eq("user_id", userId)
    ...
    return res
      .status(200)
      .json({ success: true, message: "Addresses fetched successfully", data });
  } catch (error) {
...
export const createAddress = async (req: Request, res: Response) => {
  try {
    ...
    const { data, error } = await supabase
      ...
      .select(
        "id, full_name, address_line, city, state, country, phone, zip_code, is_default",
      )
      .single();
    ...
    return res
      .status(201)
      .json({ success: true, message: "Address created successfully", data });
  } catch (error) {
...
export const updateAddress = async (
  ...
  try {
    ...
    return res
      .status(200)
      .json({ success: true, message: "Address updated successfully", data });
  } catch (error) {
...
export const setDefaultAddress = async (
  ...
  try {
    ...
    return res
      .status(200)
      .json({ success: true, message: "Default address updated", data });
  } catch (error) {

...
export const generateTokenAndCode = async (length: number = 32): Promise<{ rawToken: string; hashedToken: string; resetCode: string; hashedResetCode: string; expiresAt: string }> => {
  try {
